...
export PATH="$HOME/vendor/R/bin:$HOME/.apt/usr/bin:$HOME/.apt/usr/sbin:/usr/local/bin:/usr/local/sbin:/usr/bin:/usr/sbin:/bin:/sbin:/app/vendor/R/bin/gfortran/bin:/tmp/staged/app/.apt/usr/bin:/tmp/staged/app:$PATH"
